<%-- 
    Document   : Product_checkbox
    Created on : Jan 4, 2022, 9:36:17 PM
    Author     : arjun
--%>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
  ...
  <form action="Session_AddToCart.jsp" method="post" >
  <tbody>
      <%
      ...
      <td><%= p.getPprice()%></td>
      <td><%= p.getPcolor()%></td>
      <td><input type="checkbox" name="addtocart" value="<%= p.getId()%>"/></td>
    </tr>
       <%}%>
       <tr>
           <td colspan="4" ></td>
